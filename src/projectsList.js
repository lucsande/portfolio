...
import FileTree0 from "./pictures/filetree/filetree0.png";
import FileTree1 from "./pictures/filetree/filetree1.png";
import FileTree2 from "./pictures/filetree/filetree2.png";
import FileTree3 from "./pictures/filetree/filetree3.png";
import FileTree4 from "./pictures/filetree/filetree4.png";
...
const projectsList = {
  buddysteps: {
    ...
    github: "https://github.com/catharinavas/buddy-steps",
    tags: [
      "Fullstack",
      "Ruby on Rails",
      "Javascript",
    ...
    challenges: `This project's main challenges were creating the mood graph and making the
      chat work instantly. We also took great care in making everything mobile-friendly.`,
    gallery: [Buddy0, Buddy1, Buddy2, Buddy3, Buddy4, Buddy5, Buddy6],
  },
  fileTree: {
    id: "filetree",
    title: "SimpleFileTreeWriter",
    url: "https://file-tree-writer.now.sh/",
    github: "https://github.com/lucsande/file-tree-writer",
    tags: ["Frontend", "React", "Recursion", "Responsivity", "HTML", "CSS"],
    stack: "React, HTML, CSS, Git",
    description: `SimpelFileTreeWriter is a small web app that allows developers to quickly 
      generate directory tress with nice formatting. Directory trees in text format are an
      excellent way to reprsent an app's structure and architecture, being particularly useful
      when posting questions in online forums like StackOverflow`,
    challenges: `The main challenges were making an intuitive and fully responsive UX,
      managing global state with React Hooks and using (lots of) recursion to manipulate data stored in a tree data structure.
      Though it was a small project, it presented lots of opportunities for practicing.`,
    gallery: [FileTree0, FileTree1, FileTree2, FileTree3, FileTree4],
  },
  meucaixa: {
    id: "meucaixa",
    title: "MeuCaixa",
    url: "https://teste-caixa-eletronico.herokuapp.com/",
    github: "https://github.com/lucsande/teste-caixa",
    tags: [
      "Frontend",
      "React",
      "Ruby on Rails",
  ...
  cadedoutor: {
    ...
    github: "https://github.com/danichikawa26/cadedoutor",
    tags: ["Fullstack", "Ruby on Rails", "Javascript", "PostgresSQL", "HTML", "CSS", "Git"],
    stack: "Ruby on Rails, Javascript, PostgresSQL, HTML, CSS , Git",
    ...
    gallery: [CadeDoutor0, CadeDoutor1, CadeDoutor2, CadeDoutor3, CadeDoutor4, CadeDoutor5],
  },
  // vanilla: {
  //   id: "vanilla",
  //   title: "Vanilla One-Page-App",
  //   url: "https://vanilla-opa.herokuapp.com",
  //   tags: ["Fullstack", "Javascript", "Node.js", "Express", "HTML", "CSS", "Git"],
